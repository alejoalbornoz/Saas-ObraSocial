...
export default function Hero() {
  return (
    <div className="h-screen flex items-center justify-center px-10 relative overflow-hidden">
      ...
      {/* Contenido CENTRADO */}
      <div className="flex flex-col gap-6 w-[35%] z-10 -translate-x-[30%]">
        ...
        <button className="bg-blue-500 text-white px-6 py-3 rounded-lg cursor-pointer w-fit">
          Conoce más
        </button>
      </div>
      ...
      <Image
        ...
        width={1000}
        height={1000}
        className="absolute right-0 bottom-0 max-w-[60%] object-contain pointer-events-none"
      />
    </div>
  );
}
